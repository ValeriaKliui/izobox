import{j as t,r as o,a as Pe}from"./react-Dk2Bg5U_.js";import{u as s,t as Ae,d as De}from"./styled-components-DIsr6e24.js";import{c as Q,a as Fe}from"./@reduxjs-DVdFRU_h.js";import{u as ze,a as We,P as qe}from"./react-redux-DKmnpz9u.js";import{c as Re}from"./react-dom-D92q4Byh.js";import{L as J,N as ue,c as Te,R as He}from"./react-router-dom-B_usilBD.js";import{u as pe}from"./@react-hook-MEWzwI6z.js";import{O as Ze,e as Ye}from"./react-router-DynUQaUK.js";import{H as Xe}from"./react-router-hash-link-BcK1d0mk.js";import"./prop-types-CqkleIqs.js";import"./@emotion-BWzHn38B.js";import"./stylis-DinRj2j6.js";import"./redux-DITMfSWq.js";import"./immer-BWU1mfoO.js";import"./reselect-BeKUwQU7.js";import"./redux-thunk-ClJT1hhx.js";import"./use-sync-external-store-C8047omK.js";import"./scheduler-CzFDRTuY.js";import"./@remix-run-Cy7LQIha.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))c(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const m of l.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&c(m)}).observe(document,{childList:!0,subtree:!0});function r(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function c(a){if(a.ep)return;a.ep=!0;const l=r(a);fetch(a.href,l)}})();var D=(e=>(e.MAIN="/",e.ORDER="order",e))(D||{}),K=(e=>(e.custom="custom",e))(K||{});const _e="/assets/basic-DI6uI2O7.png",Ue="/assets/basic-1-Dz2RRaHf.png",Ge="/assets/basic-2-B6wPWTkx.png",Qe="/assets/basic-3-CKgbo5L7.png",Je="/assets/pro-4-E-aU4rpn.png",re="/assets/elzhdej-Cm_JNRjx.png",N="/assets/gallery-DEtQihVo.png",E="/assets/insida-angle-BTI08Lkd.png",I="/assets/inside-DOzl6-65.png",R="/assets/lamp-i3mUSgIU.png",he="/assets/light-CGRaAo2i.png",Ke="/assets/pro-D-zi6Jif.png",e1="/assets/pro-1-BJ-tQHyN.png",t1="/assets/pro-2-C7oBFmjL.png",i1="/assets/pro-3-DQyCTHV7.png",s1="/assets/pro-4-E-aU4rpn.png",n1="/assets/pro-5-P-UonlCg.png",ee="/assets/shelf-oU3RaI47.png",_="/assets/shelf-complect-BzCYJS__.png",o1="/assets/slider-basic-1-D1RPe9p0.png",r1="/assets/slider-basic-2-DKYvi3D1.png",a1="/assets/slider-basic-3-Eh0709oH.png",l1="/assets/slider-basic-4-BSjQ9xxi.png",c1="/assets/slider-basic-without-window-1-BeW_-J6Y.png",d1="/assets/slider-basic-2-DKYvi3D1.png",m1="/assets/slider-basic-3-Eh0709oH.png",u1="/assets/slider-basic-without-window-4--YbGv-QD.png",p1="/assets/slider-pro-1-DbpymK8J.png",h1="/assets/slider-pro-2-dTiDaVcu.png",x1="/assets/slider-pro-3-BewX_XyV.png",C1="/assets/slider-pro-4-C_OPjDQt.png",g1="/assets/wheels-B1bkZaqw.png",T="/assets/whell-Cdt2uQUm.png",f1="/assets/without-window-CQ-wpfj9.png";var M=(e=>(e[e.xs=400]="xs",e[e.sm=600]="sm",e[e.md=900]="md",e[e.lg=1280]="lg",e[e.xl=1440]="xl",e[e.xxl=1920]="xxl",e))(M||{});const te={colors:{sub:"#BFC3CF",dark:"#252525",white:"#ffffff",main:"#3CA5E9",secondary:"#C1E7FF",background:"#E7F6FF"},radiuses:{small:".6em",big:"2em"},transition:".1s ease-out"},n={xs:`@media (max-width: ${M.xs}px)`,sm:`@media (max-width: ${M.sm}px)`,md:`@media (max-width: ${M.md}px)`,lg:`@media (max-width: ${M.lg}px)`,xl:`@media (max-width: ${M.xl}px)`,xxl:`@media (max-width: ${M.xxl}px)`,xxxl:`@media (min-width: ${M.xxl}px)`},b1=s.footer`
  display: flex;
...
`,k=o.memo(({children:e,choosen:i,sub:r,...c})=>{const a=e==null?void 0:e.trim().split(" ").map((l,m)=>m===0?`${l[0].toUpperCase()}${l.slice(1)}`:l).join(" ");return t.jsx(Lt,{$choosen:i,$sub:r,...c,children:a})}),Se=s.p`
  font-size: 2.5em;
`,B=s.p`
  font-size: 1.25em;
  line-height: 120%;
...
`,Nt=s(St)`
  ...
  background-color: ${({theme:{colors:e}})=>e.main};
  border-radius: ${({theme:{radiuses:e}})=>e.big};
`,Pt=()=>t.jsxs("div",{className:"flex-col-gap",children:[t.jsx("p",{children:"Опишите необходимые Вам аксессуары"}),t.jsxs(Bt,{children:[t.jsx(Et,{placeholder:"Стол, кастомный столик, полки, крепления для оборудования и т.д."}),t.jsxs("div",{className:"flex-col-gap",children:[t.jsx("p",{children:"Прикрепите фото примеры"}),t.jsxs(It,{children:[t.jsxs(Vt,{children:[t.jsx(Nt,{}),t.jsxs(B,{className:"primary-text bold underline",children:["Выберите на устройстве"," "]})," ",t.jsx(B,{children:"или перетащите файлы"})]}),t.jsx(Ot,{type:"file"})]}),t.jsx(k,{children:"Прикрепить"})]})]})]});var g=(e=>(e.inside="Внутри",e.outside="Снаружи",e))(g||{});const At=s.div`
  display: flex;
  flex-direction: column;
  gap: 0.5em;
`,Dt=s.div`
...
`,Z=o.memo(({colors:e,title:i,colorType:r})=>{const c=w(),a=v(ve),l=v(we),m=r===g.inside?a:l,p=d=>{r===g.inside?c(be(d)):c(je(d))};return r===g.inside&&!e.find(d=>d===a)&&a!==null&&e.push(a),r===g.outside&&!e.find(d=>d===l)&&l!==null&&e.push(l),t.jsxs(At,{children:[t.jsx("p",{className:"semibold",children:i}),t.jsx(Dt,{children:e.map(d=>t.jsx(Ft,{$color:d,$isChoosen:d===m,onClick:()=>p(d)},d))})]})}),zt=s.div`
  margin: 1em 0;
`,Wt=s.div`
  display: flex;
  gap: 5em;
  margin-bottom: 1em;
`,qt=()=>{const{izobox:e}=L(),i=w(),r=()=>i(ye());return t.jsxs(t.Fragment,{children:[t.jsx("p",{children:"Выбери цвет и тип декора"}),t.jsxs(zt,{children:[t.jsxs(Wt,{children:[t.jsx(Z,{colors:e.colorsInside,title:"Цвет внутри",colorType:g.inside}),t.jsx(Z,{colors:e.colorsOutside,title:"Цвет снаружи",colorType:g.outside})]}),t.jsx("p",{className:"bold underline pointer",onClick:r,children:"Все цвета"})]})]})};var S=(e=>(e.walls="Стены",e.windows="Окна",e.door="Дверь",e.port="Кабель порт",e.hood="Вытяжка",e))(S||{});const Rt=s.div`
...
`,Ht=o.memo(({title:e,children:i,isOpened:r,onClick:c})=>t.jsxs(Rt,{$isOpened:r,children:[t.jsx(Tt,{$isOpened:r,onClick:c,children:t.jsx("p",{className:r?"bold":"",children:e})}),i]})),Zt=s.label`
  cursor: pointer;
  display: flex;
  gap: 0.2em;
  p:first-letter {
...
`,ne=o.memo(({values:e,handleChange:i=()=>{},classNameForActive:r})=>{const[c,a]=o.useState(e[0].value),l=p=>{i(p.target.value),a(p.target.value)},m=p=>p===c;return t.jsx(t.Fragment,{children:e.map(({text:p,value:d=""})=>t.jsx(o.Fragment,{children:p&&t.jsxs(Zt,{className:m(d)?r:"",children:[t.jsx("input",{value:d,checked:m(d),onChange:l,type:"radio"}),t.jsxs("p",{children:[" ",p]})]})},d))})}),Yt=s.div`
  margin-top: 1em;
`,Xt=s.div`
  display: flex;
  gap: 0.5em;
...
`,Gt=s.div`
  display: flex;
  justify-content: space-between;
`,Ie=o.memo(({initValue:e,name:i})=>{const[r,c]=o.useState(e),a=l=>{c(Number(l.target.value))};return t.jsxs(Yt,{children:[t.jsxs(Gt,{children:[t.jsxs("p",{className:"sub-color",children:[i,":"]}),t.jsxs(Xt,{children:[t.jsx(Ut,{value:r,onChange:a}),t.jsx("p",{children:"мм"})]})]}),t.jsx(_t,{type:"range",min:0,max:2e3,value:r,onChange:a})]})}),Qt=s.div`
  grid-row-start: 5;
  display: flex;
  justify-content: space-between;
  align-items: center;
...
`,Kt=s.button`
  ...
  outline: unset;
  border: unset;
`,ei=o.memo(({title:e,values:i})=>{const[r,c]=o.useState(i[0]),a=l=>c(l);return t.jsxs(Qt,{children:[t.jsxs("p",{className:"sub-color",children:[e,":"]}),t.jsx(Jt,{children:i.map(l=>t.jsx(Kt,{onClick:()=>a(l),$isChoosen:r===l,children:l},l))})]})}),ti=s.div`
  display: grid;
...
`,q=o.memo(({items:e,isOpened:i})=>{const r=o.useMemo(()=>e.map(({title:m})=>({value:m,text:m})),[e]),[c,a]=o.useState(""),l=o.useCallback(m=>a(m),[]);return t.jsxs(ti,{children:[t.jsx(ne,{values:r,handleChange:l,classNameForActive:"bold"}),e.map(({dimensions:m,title:p,pickers:d},h)=>t.jsxs(o.Fragment,{children:[t.jsx(ii,{$index:(h+1)*2,$isChoosen:!p||p===c,$isOpened:i,children:m.map(({name:u,initValue:j})=>t.jsx(Ie,{initValue:j,name:u},u))},p),d==null?void 0:d.map(({title:u,values:j})=>t.jsx(ei,{title:u,values:j},u))]},p))]})}),si=s.div`
...
`,oi=s.div`
  display: flex;
  flex-direction: column;
`,ri=()=>t.jsx("div",{className:"flex-col-gap",children:E1.map(({title:e,dimensions:i})=>t.jsxs(oi,{children:[t.jsx("p",{className:"bold",children:e}),t.jsx("div",{children:i.map(({initValue:r,name:c})=>t.jsx(Ie,{initValue:r,name:c},c))})]},e))}),ai=()=>{const[e,i]=o.useState(S.walls),r=a=>{i(a)},c=(a,l)=>{switch(a){case S.walls:return t.jsx(ri,{});case S.windows:return t.jsx(q,{items:B1,isOpened:l});case S.port:return t.jsx(q,{items:I1,isOpened:l});case S.door:return t.jsx(q,{items:V1,isOpened:l});case S.hood:return t.jsx(q,{items:O1,isOpened:l})}};return t.jsx(si,{children:Object.values(S).map(a=>{const l=e===a;return t.jsx(Ht,{title:a,isOpened:l,onClick:()=>r(a),children:t.jsx(ni,{$isOpened:l,children:c(a,l)})},a)})})},li=()=>t.jsxs("div",{className:"flex-col-gap",children:[t.jsx("p",{children:"Cконфигурируй размер кабинки"}),t.jsx(ai,{})]}),ci=s.input`
  padding: 1em 0;
  border: none;
...
`,P=o.memo(({...e})=>t.jsx(ci,{...e})),di=s.div`
  display: grid;
...
`,mi=()=>t.jsxs("div",{children:[t.jsx("p",{children:"Заполните информацию о себе"}),t.jsxs(di,{children:[t.jsx(P,{placeholder:"Ф.И.О."}),t.jsx(P,{placeholder:"Телефон"}),t.jsx(P,{placeholder:"Город"}),t.jsx(P,{placeholder:"Адрес"}),t.jsx(P,{placeholder:"E-mail"}),t.jsx(P,{placeholder:"Комментарий"})]})]});var y=(e=>(e[e.First=0]="First",e[e.Second=1]="Second",e[e.Third=2]="Third",e[e.Fourth=3]="Fourth",e))(y||{});const ui=s.div`
  display: flex;
  align-items: center;
  gap: 2em;
  ${n.xs} {
...
`,Ci=()=>{const e=Ye(),[i,r]=o.useState(0),c=4,a=o.useCallback(()=>{i<c-1&&r(p=>p+1),i===y.Fourth&&e("/order")},[i,e]),l=o.useCallback(()=>{i>0&&r(p=>p-1)},[i]),m=()=>{switch(i){case y.First:return"Запомнить и продолжить";case y.Fourth:return"Запросить стоимость и сроки";default:return"Дальше"}};return t.jsxs("div",{className:"wrapper flex-col-gap",children:[t.jsxs(ui,{children:[t.jsxs(Se,{className:"bold",children:["Шаг ",i+1]}),t.jsx(pi,{children:Array(c).fill(1).map((p,d)=>t.jsx(hi,{onClick:()=>r(d),$isCurrent:i===d},d))})]}),i===y.First&&t.jsx(li,{}),i===y.Second&&t.jsx(qt,{}),i===y.Third&&t.jsx(Pt,{}),i===y.Fourth&&t.jsx(mi,{}),t.jsxs(xi,{children:[i!==y.First&&t.jsx(k,{sub:!0,onClick:l,children:"Назад"}),t.jsx(k,{onClick:a,children:m()})]})]})},Y=e=>o.createElement("svg",{width:78,height:78,viewBox:"0 0 78 78",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},o.createElement("path",{d:"M22.75 32.5L39 48.75L55.25 32.5",stroke:"#3CA5E9",strokeWidth:6,strokeLinecap:"round",strokeLinejoin:"round"})),gi=s.div`
  display: flex;
  gap: 1em;
  align-items: center;
  cursor: pointer;
...
`,Ve=()=>{const e=w(),i=v(Z1);return{onContentClick:(a,l)=>{e(le(l)),e(H(a)),e(q1())},onContentClose:()=>{e(le([])),e(R1()),e(H(0))},isModalOpened:i}};var A=(e=>(e.description="Описание",e.photo="Фото",e.video="Видео",e))(A||{});const Bi=s.div`
  display: flex;
  gap: 1em;
`,Ei=s(B)`
...
`,Ti=s(Wi)`
  ...
  align-self: flex-end;
  margin: 0.5em;
`,Oe=o.memo(({isOpened:e,onClose:i,children:r})=>t.jsx(qi,{$isOpened:e,onClick:i,children:t.jsxs(Ri,{onClick:c=>c.stopPropagation(),children:[t.jsx(Ti,{onClick:i}),r]})})),Hi=s.div`
  display: flex;
  align-items: center;
  position: relative;
  z-index: 1000;
...
`,es=s(Ne)`
  transform: rotate(90deg);
`,ts=o.memo(({sliderPhotos:e})=>{const i=o.useRef(null),r=pe(),[c,a]=o.useState(0),[l,m]=o.useState(0),[p,d]=o.useState({first:!0,second:!1}),h=4,u=10,{onContentClick:j,onContentClose:F,isModalOpened:C}=Ve(),$=()=>{m(f=>{const b=f-c-u,O=Math.abs(b/(c+u))+h;return d(X=>({...X,first:!1})),O===e.length&&d(X=>({...X,second:!0})),O>e.length?f:b})},W=()=>{m(f=>{const b=f+c+u;return d(O=>({...O,second:!1})),b>=0?(d(O=>({...O,first:!0})),0):b})};return o.useEffect(()=>{var b;const f=(b=i==null?void 0:i.current)==null?void 0:b.getBoundingClientRect().height;f&&a(f)},[r]),t.jsxs(t.Fragment,{children:[t.jsxs(Gi,{className:"flex-col-gap",children:[t.jsx(es,{onClick:W,$disabled:p.first}),t.jsx(Qi,{$height:c&&h*(c+u),children:t.jsx(Ji,{$gap:u,$scrollHeight:l,children:e.map((f,b)=>t.jsx(Ki,{src:f,ref:i,onClick:()=>j(b,e)},f))})}),t.jsx(Ne,{onClick:$,$disabled:p.second})]}),t.jsx(Oe,{isOpened:C,onClose:F,children:t.jsx(Ui,{})})]})}),is=s.div`
  display: grid;
...
`,ns=s.div`
  display: flex;
  gap: 1em;
`,os=()=>{const e=w(),i=v(ve),r=v(we),{izobox:c}=L(),{allColors:a}=c,[l,m]=o.useState(g.inside),p=o.useCallback(u=>{m(u)},[]),d=u=>{l===g.inside&&e(be(u)),l===g.outside&&e(je(u))},h=o.useMemo(()=>[{value:g.inside,text:"Цвет внутри"},{value:g.outside,text:"Цвет снаружи"}],[]);return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"flex-col-gap",children:[t.jsx("p",{className:"bold",children:"Выберите тип"}),t.jsx(ns,{children:t.jsx(ne,{values:h,handleChange:p})})]}),t.jsx(is,{children:a==null?void 0:a.map(u=>t.jsx(ss,{onClick:()=>d(u),$color:u,$isChoosen:l===g.inside&&u===i||l===g.outside&&u===r},u))})]})},rs=s.div`
  display: flex;
  gap: 1em;
  ${n.md} {
    flex-direction: column;
...
`,us=()=>{const e=w(),i=o.useMemo(()=>Object.entries(z).map(c=>({value:c[0],text:c[1]})),[]),r=o.useCallback(c=>z[c]===z.with?e(G(x.basic)):e(G(x.basicWithoutWindow)),[e]);return t.jsx(ms,{children:t.jsx(ne,{values:i,handleChange:r})})},ps=()=>{const e=w(),{izobox:i}=L(),r=()=>e(ye());return t.jsxs(t.Fragment,{children:[t.jsx(us,{}),t.jsx(Z,{colors:i.colorsInside,title:"Цвет внутри",colorType:g.inside}),t.jsx(Z,{colors:i.colorsOutside,title:"Цвет снаружи",colorType:g.outside}),t.jsx("p",{className:"bold underline pointer",onClick:r,children:"Все цвета"}),t.jsx(ds,{}),t.jsxs(rs,{children:[t.jsx(J,{to:D.ORDER,children:t.jsx(k,{children:"Купить"})}),t.jsx(k,{sub:!0,children:"В кредит"})]})]})},hs=s.div`
  display: flex;
  gap: 1em;
  ${n.md} {
    align-self: center;
  }
`,xs=()=>{const{izobox:e,chooseIzobox:i}=L(),r=w(),c=a=>{i(a),r(N1())};return t.jsx(hs,{children:Object.values(x).filter(a=>a!==x.basicWithoutWindow).map(a=>t.jsx(k,{choosen:e.type===x.basicWithoutWindow?a===x.basic:e.type===a,onClick:()=>c(a),children:a},a))})},Cs=()=>t.jsxs("div",{className:"flex-col-gap",children:[t.jsxs(B,{className:"semibold",children:[t.jsx("span",{children:"Создай студию своей мечты вместе с "}),t.jsx("span",{className:"bold",children:"IzoBox™"})]}),t.jsx("ul",{children:V.pro.options.map(e=>t.jsx(U,{children:t.jsx("p",{children:e})},e))})]}),gs=s.div`
  display: flex;
  ${n.lg} {
    flex-direction: column;
    align-items: center;
...
`,ws=()=>{const{izobox:e}=L(),{type:i,sliderPhotos:r,photo:c}=e,a=w(),l=v(H1),m=()=>{a(W1())};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"wrapper",id:K.custom,children:[t.jsxs("h3",{children:["IzoBox"," ",t.jsx(js,{className:"primary-text",children:i===x.basicWithoutWindow?x.basic:i})]}),t.jsxs(gs,{children:[t.jsxs(fs,{children:[t.jsx(ts,{sliderPhotos:r}),t.jsx("img",{src:c})]}),t.jsxs(bs,{children:[t.jsx(xs,{}),(i===x.basic||i===x.basicWithoutWindow)&&t.jsx(ps,{}),i===x.pro&&t.jsx(Cs,{})]})]})]}),t.jsx(Oe,{isOpened:l,onClose:m,children:t.jsx(os,{})})]})},vs="/assets/cabine-LWdfY5sA.png",$s="/assets/cabine-b-fCUyXa0i.png",ys="data:image/svg+xml,%3csvg%20width='21'%20height='21'%20viewBox='0%200%2021%2021'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M14.4615%2014L20%209.01806M20%209.01806L14.4615%204M20%209.01806H2'%20stroke='black'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",Ms="/assets/IzoBox-ql-nxIbL.png",ks=s.div`
  display: flex;
  flex-direction: column;
...
`,Ts=()=>t.jsx(Ds,{children:t.jsx(Fs,{className:"wrapper",children:L1.map(({review:e,avatarSrc:i,job:r,name:c},a)=>t.jsxs(t.Fragment,{children:[a===1&&t.jsx(Rs,{src:As}),t.jsxs(zs,{className:"flex-col-gap",children:[t.jsx(Ee,{children:e}),t.jsxs(Ws,{children:[t.jsx(qs,{src:i}),t.jsxs("div",{children:[t.jsx(Be,{className:"bold",children:c}),t.jsx("p",{children:r})]})]})]})]},a))})}),Hs=()=>{const[e,i]=o.useState(!1),[r,c]=o.useState([]),a=w(),l=v(J1),m=()=>i(h=>!h),p=o.useCallback(h=>()=>{const u=l.includes(h);a(u?Q1(h):G1(h))},[a,l]),d=o.useCallback(h=>()=>{c(u=>u.includes(h)?u.filter(j=>j!==h):[...u,h])},[]);return t.jsxs("div",{className:"wrapper",children:[t.jsxs(gi,{onClick:m,children:[t.jsx("h3",{className:"primary-text",children:"Прокачай свой IzoBox"}),t.jsx(oe,{$isShown:e})]}),t.jsx(B,{children:"Добавить дополнительные опции"}),e&&t.jsx(fi,{children:S1.map(({option:h,description:u,photo:j,price:F,galleryPhotos:C,id:$})=>{const W=l.includes($),f=r.includes($);return t.jsxs(bi,{children:[t.jsx(vi,{src:j}),t.jsxs("div",{className:"flex-col-gap",children:[t.jsxs(ji,{onClick:d($),children:[t.jsx("h4",{children:h}),t.jsx(wi,{$isShown:f})]}),t.jsx($i,{$isDescShowed:f,children:u})]}),t.jsx(Mi,{children:t.jsx(k,{onClick:p($),sub:W,children:W?"Добавлено":"Добавить"})}),t.jsxs(ki,{children:[t.jsx(Li,{src:j}),C.map(b=>t.jsx(Si,{src:b},b))]}),t.jsxs(yi,{children:[F.toLocaleString()," руб."]})]},$)})})]})},Zs=()=>{const{izobox:e}=L();return t.jsxs(t.Fragment,{children:[t.jsx(Ps,{}),t.jsx(Ts,{}),t.jsx(ws,{}),t.jsx(zi,{}),e.type===x.basic&&t.jsx(Hs,{}),e.type===x.pro&&t.jsx(Ci,{})]})},Ys=e=>o.createElement("svg",{width:75,height:75,viewBox:"0 0 75 75",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},o.createElement("path",{d:"M32.8125 50.1891L21.0938 38.468L24.4055 35.1562L32.8125 43.5609L50.5898 25.7812L53.9062 29.0977L32.8125 50.1891Z",fill:"#3CA5E9"}),o.createElement("path",{d:"M37.5 4.6875C31.0103 4.6875 24.6664 6.61192 19.2704 10.2174C13.8744 13.8229 9.66872 18.9475 7.18522 24.9432C4.70172 30.9389 4.05192 37.5364 5.318 43.9014C6.58408 50.2664 9.70916 56.113 14.2981 60.7019C18.887 65.2909 24.7336 68.4159 31.0986 69.682C37.4636 70.9481 44.0611 70.2983 50.0568 67.8148C56.0525 65.3313 61.1771 61.1256 64.7826 55.7296C68.3881 50.3337 70.3125 43.9897 70.3125 37.5C70.3125 28.7976 66.8555 20.4516 60.702 14.2981C54.5484 8.14452 46.2024 4.6875 37.5 4.6875ZM37.5 65.625C31.9374 65.625 26.4997 63.9755 21.8746 60.8851C17.2495 57.7947 13.6446 53.4021 11.5159 48.263C9.38719 43.1238 8.83022 37.4688 9.91543 32.0131C11.0006 26.5574 13.6793 21.546 17.6126 17.6126C21.546 13.6793 26.5574 11.0006 32.0131 9.91541C37.4688 8.8302 43.1238 9.38717 48.263 11.5159C53.4022 13.6446 57.7947 17.2495 60.8851 21.8746C63.9755 26.4997 65.625 31.9374 65.625 37.5C65.625 44.9592 62.6618 52.1129 57.3874 57.3874C52.1129 62.6618 44.9592 65.625 37.5 65.625Z",fill:"#3CA5E9"})),Xs=s.div`
  align-items: center;
  justify-content: center;
  ${n.lg} {
    gap: 2em !important;
...
`,pn=Te([{element:t.jsx(yt,{}),path:D.MAIN,children:[{element:t.jsx(Zs,{}),index:!0},{element:t.jsx(Js,{}),path:"politics"},{path:D.ORDER,element:t.jsx(Gs,{})}]}]);Re.createRoot(document.getElementById("root")).render(t.jsx(Pe.StrictMode,{children:t.jsx(qe,{store:et,children:t.jsxs(z1,{children:[t.jsx(un,{}),t.jsx(F1,{children:t.jsx(He,{router:pn})})]})})}));
